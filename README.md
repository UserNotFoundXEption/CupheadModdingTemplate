...
12. Modding template has some instructions and basic code inside. Have fun and mod something.  
13. Press Ctrl + B to build project.
14. Copy "CupheadModdingTemplate/bin/debug/net35/CupheadModdingTemplate.dll" to "Cuphead directory/BepInEx/plugins"
15. Launch the game and see if it works.
